...
{
    /// <inheritdoc />
    public partial class Initial_Clean_Schema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientProfiles_AspNetUsers_UserAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MerchantProfiles_AspNetUsers_UserAccountId",
                        column: x => x.UserAccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShelterProfiles_AspNetUsers_UserAccountId",
                        column: x => x.UserAccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VetProfiles_AspNetUsers_UserAccountId",
                        column: x => x.UserAccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MerchantProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Products_MerchantProfiles_MerchantProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    VetProfileId = table.Column<int>(type: "int", nullable: true),
                    ShelterProfileId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Services", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Services_ShelterProfiles_ShelterProfileId",
                        column: x => x.ShelterProfileId,
                        principalTable: "ShelterProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Services_VetProfiles_VetProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VetProfileId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingDays_ShelterProfiles_ShelterProfileId",
                        column: x => x.ShelterProfileId,
                        principalTable: "ShelterProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkingDays_VetProfiles_VetProfileId",
                        column: x => x.VetProfileId,
                        principalTable: "VetProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_ClientProfiles_ClientProfileId",
                        column: x => x.ClientProfileId,
                        principalTable: "ClientProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_ClientProfileId",
                table: "CartItems",
                column: "ClientProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientProfiles_UserAccountId",
                table: "ClientProfiles",
                column: "UserAccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MerchantProfiles_UserAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pets_ClientProfileId",
                table: "Pets",
                column: "ClientProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_MerchantProfileId",
                table: "Products",
                column: "MerchantProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Services_ShelterProfileId",
                table: "Services",
                column: "ShelterProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Services_VetProfileId",
                table: "Services",
                column: "VetProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ShelterProfiles_UserAccountId",
                table: "ShelterProfiles",
                column: "UserAccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VetProfiles_UserAccountId",
                table: "VetProfiles",
                column: "UserAccountId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingDays_ShelterProfileId",
                table: "WorkingDays",
                column: "ShelterProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkingDays_VetProfileId",
                table: "WorkingDays",
                column: "VetProfileId");
        }
